...
<center><h2>管理员添加</h2><a type="button" class="btn btn-info" href="{{url('/admin/index')}}">列表</a></center>
<!-- @if ($errors->any()) 
...
<form class="form-horizontal" role="form" action="{{url('/admin/store')}}" method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="admin_name" placeholder="请输入名称">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="admin_tel" placeholder="请输入手机号">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="admin_email" placeholder="请输入邮箱">
